...
class TimePickerLayout @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = 0
) : LinearLayout(context, attrs, defStyleAttr) {
    private val strokeW = 1F
    private val offset = dpToPx(context,strokeW/2F)
    private val roundCorner = dpToPx(context,4F)
    ...
    init{
        ...
        paint300.apply {
            ...
            strokeWidth = dpToPx(context, strokeW)

...
class CalendarLongFragment: BaseFragment<FragmentCalendarLongBinding>(R.layout.fragment_calendar_long)  {
    ...
    override fun initView() {
        binding.calendarLongView.initCalendar(DateTime(millis), CalendarUtil.getMonthList(DateTime(millis)))
    }
